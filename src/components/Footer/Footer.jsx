          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <address className="not-italic text-gray-400 space-y-2">
                <p>123 Marvel Avenue</p>
                <p>New York, NY 10001</p>
                <p className="mt-4">Email: info@marvelwear.com</p>
                <p>Phone: (800) 123-4567</p>
              </address>
            </div>
          </div>
          <div className="pt-8 border-t border-gray-800 text-sm text-gray-400 text-center">
            <p>&copy; {new Date().getFullYear()} MARVELWEAR. All rights reserved.</p>
            <p className="mt-2">Marvel and all related characters are trademarks of Marvel Entertainment, LLC.</p>
          </div>
        </div>
      </footer>
    )
